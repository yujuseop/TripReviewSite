      ...
      <div className="space-y-2 mb-2">
        <div className="flex gap-2">
          <input
            ...
            className="border p-2 flex-1 rounded text-xs md:text-sm"
          />
          <select
            value={state.destDay}
            onChange={(e) =>
        ...
        <input
          ...
          className="border p-2 w-full rounded text-xs md:text-sm"
        />
        <div className="flex gap-2">
          <button
            type="button"
            onClick={addDestination}
            className="px-3 py-1 text-xs md:text-sm bg-gray-200 rounded hover:bg-gray-300"
          >
            + 목적지 추가
          </button>
        </div>
